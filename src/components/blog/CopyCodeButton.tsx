...
export function CopyCodeButton() {
  useEffect(() => {
    ...
    codeBlocks.forEach((pre) => {
      ...
      button.className =
        'copy-code-btn absolute top-2 right-2 p-1.5 rounded-md hover:bg-secondary/50 text-muted-foreground hover:text-foreground transition-all opacity-0 group-hover:opacity-100';
      // 剪贴板图标 (clipboard)
